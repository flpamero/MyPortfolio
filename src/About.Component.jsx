          ...
          <Col xs={12} md={6}>
            <Row className="pl-3 pr-3">
              Hi there! I am <strong>&nbsp;Francis Pamero</strong>
                ...
                <br />
                <br />
                I started working since 2017 as a Production Leader at Pizzahut.
                In 2020, I successfully completed my course Bs in Information System in City College of Angeles.
                In 2022, I started working at Fujitsu(Weserv) as Application System Engineer in bootcamp program,
                In 2024, I got promoted as a Junior Software Engineer. for the span of 3yrs i've handle 3 projects including my current project.
                <br />
                <br />
